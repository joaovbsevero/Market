...
class SaleListPage(QtWidgets.QWidget):
    def __init__(self, back_signal, *args):
        super(SaleListPage, self).__init__(*args)
    ...
    def clear(self):
        ...
        result, sales, message = self.controller.get_sales_by_value_and_date(min_sale, max_sale,
